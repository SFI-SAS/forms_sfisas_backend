...
#     # Nuevo campo para categoría
#     id_category = Column(BigInteger, ForeignKey('form_categories.id'), nullable=True)
#     is_enabled = Column(Boolean, nullable=False, default=True)  # ✅ Cambiado
...
#     id = Column(BigInteger, primary_key=True, autoincrement=True)
#     question_text = Column(String(255), nullable=False)
#     question_type = Column(Enum(QuestionType), default=QuestionType.text, nullable=False)  # ✅ Cambiado
#     required = Column(Boolean, nullable=False, default=True)  # ✅ Cambiado
#     root = Column(Boolean, nullable=False, default=False)  # ✅ Cambiado
